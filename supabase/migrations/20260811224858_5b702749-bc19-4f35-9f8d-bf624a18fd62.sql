...
BEGIN
  ...
  WITH nodes AS (
    -- SOLO la receta directa del producto vendido. Nunca se abren subrecetas.
    SELECT r.id AS recipe_id, oi.quantity::numeric AS factor
  ...
  needs AS (
    ...
    UNION ALL
    -- subrecetas: se descuenta su producto terminado, como un solo ítem
